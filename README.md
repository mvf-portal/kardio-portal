# Kardiologie · Rechercheportal

Ein Rechercheportal zum Themenfeld **Kardiologie**: 53 Datenbanken in 9 Rubriken,
...
dort indexiert sind (84 Begriffe).

| | |
|---|---|
| Datenbanken | 53 in 9 Rubriken |
| Live-Suche | 28 |
| Portal (feste URL) | 20 |
| Lizenz nötig | 5 |
| Suchglossar | 84 Begriffe |
...
Secrets im Repository: `KARDIOHUB` (Claude-API) und `KARDIOHUBMC` (Mailchimp).
